...
const cadets = [
  // 1st Year Cadets
  //1st year cdts are not confirm yet.
//   {
...
function loadAttendanceForDate(date) {
  ...
  filteredCadets.forEach((cadet) => {
    ...
    row.innerHTML = `
            ...
            <td>
                <span class="year-badge year-${cadet.year}">${cadet.year}${
      cadet.year === 1 ? "st" : cadet.year === 2 ? "nd" : "rd"
    } Year</span>
            </td>
            <td>
                ...
                <div class="attendance-controls">
                    <div class="radio-group">
                        ...
                        <label class="radio-option absent">
                            <input type="radio" name="attendance_${
                              cadet.id
                            }" value="absent" ${!isPresent ? "checked" : ""}>
                    ...
                    <div class="cadet-record ${record.status}">
                        ...
                        <div class="record-details">
                            ${
                              cadet
                                ? `
                                <span class="year-badge year-${cadet.year}">${
                                    cadet.year
                                  }${
                                    cadet.year === 1
                                      ? "st"
...
function loadDashboardData() {
  ...
  document.getElementById("mostActive").textContent = bestYear
    ? `${bestYear[0]}${
        bestYear[0] == 1 ? "st" : bestYear[0] == 2 ? "nd" : "rd"
      } Year`
    : "-";
      ...
      ([year, stats]) => `
        <div class="stat-item">
            <div class="stat-header">
                <span class="year-badge year-${year}">${year}${
        year == 1 ? "st" : year == 2 ? "nd" : "rd"
      } Year</span>
        ...
        <div class="performer-item">
            ...
            <div class="performer-info">
                ...
                <div class="performer-details">
                    <span class="year-badge year-${performer.cadet.year}">${
        performer.cadet.year
      }${
        performer.cadet.year === 1
          ? "st"
          : performer.cadet.year === 2
          ? "nd"
          : "rd"
      }</span>
                </div>
